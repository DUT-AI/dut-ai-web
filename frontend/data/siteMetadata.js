const SITE_URL = (process.env.NEXT_PUBLIC_SITE_URL || 'https://clb.dutai.io.vn').replace(/\/+$/, '')
...
const siteMetadata = {
  ...
  youtube: 'https://youtube.com/@dutaiclub',
  linkedin: 'https://www.linkedin.com/company/dutai',
  threads: '',
