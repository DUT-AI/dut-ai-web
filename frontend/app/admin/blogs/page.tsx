                ...
                <tr key={blog.id} className="hover:bg-slate-50/80 dark:hover:bg-slate-800/40 transition">
                  ...
                  <td className="px-6 py-4">
                    ...
                    <div className="mt-1 flex items-center gap-2">
                      <span className="rounded-md bg-blue-50 px-2 py-0.5 font-mono text-xs font-semibold text-blue-600 dark:bg-blue-950/50 dark:text-blue-400">
                        {blog.slug || 'chưa-có-slug'}
                      </span>
                      {blog.slug && (
                        <Link
                          href={`/blog/${blog.slug}`}
